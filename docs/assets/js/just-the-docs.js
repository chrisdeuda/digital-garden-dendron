(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://chrisdeuda.github.io/digital-garden-dendron/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://chrisdeuda.github.io/digital-garden-dendron/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://chrisdeuda.github.io/digital-garden-dendron/assets/css/just-the-docs-' + theme + ".css"
      );
    };
